...
class KaryawanTest extends DuskTestCase
{
    ...
    {
        $this->browse(function (Browser $browser) {
            $browser->type('input[type=search]', 'fagil')
                    ->pause(1000) 
                    ->assertSee('Fagil Nuril Akbar') 
                    ->assertDontSee('Shania Yan') 
                    ->pause(1000);
