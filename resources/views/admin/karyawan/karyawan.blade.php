                ...
                <form action="{{ route('admin.karyawan.add') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class=" d-flex flex-column">
                            ...
                            <input class=" form-control" type="text" id="nik" name="nik" placeholder="Masukkan Nomer Induk Karyawan" value="{{old('nik')}}">
                            @error('nik')
                        ...
                        <div class="mt-3 d-flex flex-column">
                            ...
                            <input class=" form-control" type="text" id="username" name="username" placeholder="Masukkan Username" value="{{old('username')}}">
                            @error('username')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mt-3 d-flex flex-column">
                            ...
                            <select class=" form-control" name="departement_id" id="departement_id" placeholder="Masukkan Departemen" >
