    ...
    <head>
        ...
        <style>
            ...
            .profile img {
                ...
                height: 100%;
                object-fit: cover;
                /* Mengisi bingkai tanpa merusak rasio aspek */
                cursor: pointer;
            }
        ...
        <div class="profile">
            ...
            <div class="container">
                ...
                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                    <form id="foto-profile" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div
                                style="position: relative; display: inline-block;  width: 125px; height: 125px; overflow: hidden; ">
                                <!-- Foto Profil -->
                                <img id="profile_photo"
                                    src="{{ $user->avatar ? asset('storage/photos/' . $user->avatar) . '?' . time() : asset('img/user.jpg') }}"
                                    alt="Profile Photo" style="max-width: 125px; cursor: pointer; border-radius: 50%;"
                                    onclick="document.getElementById('photo-input').click();">

                                <!-- Ikon Plus -->
                                <div
                                    style="position: absolute; bottom: 5px; right: 5px; background-color: #ffffff; border-radius: 50%;">
                ...
                <form id="update_dataprofile" action="{{ route('profile.update_dataprofile', $user->id) }}" method="POST">
                    ...
                    <p style="font-size: 15px; font-weight: bold;">Silahkan lengkapi profile atau isi kembali jika terdapat
                    ...
                    <p class="fs-10">NIK</p>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" {{-- placeholder="{{ $user->nik }}"  --}} value="{{ $user->nik }}"
                            aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" readonly>
                    </div>

                    <p class="fs-10">Perusahaan</p>
                    <div class="input-group mb-3">
                        <input class="form-control" {{-- placeholder="{{ $user->nik }}"  --}} value="{{ $user->departemen->nama_departemen }}"
                            aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" readonly>
                    </div>
                ...
                <form action="{{ route('profile.update_pass', $user->id) }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input id="new_password" name="new_password" type="password" class="form-control"
                            placeholder="Silahkan isi password" hi aria-label="Sizing example input"
                            aria-describedby="inputGroup-sizing-default">
                    </div>
