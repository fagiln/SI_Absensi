    ...
    <head>
        ...
        <style>
            ...
            .button-container {
                ...
                /* Mengatur posisi tombol ke kiri */
                margin-top: 10px;
                /* Tambahkan margin atas untuk pemisahan dari foto */
            }
            ...
            .btn-custom {
                padding: 10px 20px;
                /* Ukuran padding untuk memperbesar tombol */
                font-size: 16px;
            ...
            .modal-footer {
                padding: 10px 0;
                /* Mengatur jarak antara footer dan konten modal */
            }
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="loading-indicator" class="d-none mt-3" style="width:100%">
                ...
                <div class="modal-dialog modal-dialog-centered" style="justify-content: center">
                    <div class="modal-content" style="width: 60%">
                        <div class="modal-body text-center">
                            ...
                            <img src="{{ asset('img/Emoji_berhasil.svg') }}" alt="Absen Berhasil" width="150"
                                height="100">
                            ...
                            <div class="modal-footer justify-content-center">
                                ...
                                <a id="waLink" href="#" target="_blank" class="btn btn-success">Kirim Pesan
                                    WhatsApp</a>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            ...
            function takePhoto() {
                ...
                retakePhotoButton.addEventListener('click', function() {
                    ...
                    takePhotoButton.textContent = 'Absen Pulang'; // Kembalikan tombol menjadi "Absen"
                ...
                fetch(url)
                    ...
                    .then(data => {
                        if (data && data.display_name) {
                            ...
                            document.getElementById('alamat-spesifik').textContent =
                                'Tidak dapat menemukan alamat spesifik.';
                        }
                    })
                    .catch(error => {
                        console.error('Kesalahan saat melakukan reverse geocoding:', error);
                        document.getElementById('alamat-spesifik').textContent =
                            'Kesalahan saat mengambil alamat spesifik.';
                    });
            }
            ...
            function confirmAbsen() {
                const confirmButton = document.getElementById('confirm-absen');
                ...
                fetch('/user/absen_pulang', {
                    ...
                    .then(response => {
                        ...
                        if (response.success) {
                            ...
                            var waLink =
                                `https://wa.me/${phone}?text=${encodeURIComponent(message)} Lokasi saya: https://www.google.com/maps?q=${latitude},${longitude}`;
