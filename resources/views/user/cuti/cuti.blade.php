    ...
    <head>
        ...
        <style>
            ...
            .date-input {
                ...
                font-size: 16px;
                border: 2px solid crimson;
                /* Sama dengan border pada dropdown */
                border-radius: 4px;
                background-color: white;
            }
    ...
    <body>
        <div style="padding-top: 10px">
            <div class="container">
                ...
                <div style="padding: 20px; margin-top: 15px; border: 2px solid crimson; border-radius: 10px">
                    ...
                    <form method="POST" action="{{ route('cuti.create') }}" enctype="multipart/form-data"
                        ...
                        <p style="margin: 0; padding: 0; margin-top: 10px; font-size: 18px; font-weight: bold;">Formulir
                            Pengajuan Cuti</p>
                        ...
                        <div class="custom-dropdown-container">
                            <select id="filter_izin" name="filter_izin" class="custom-dropdown" onchange="toggleIcon()">
                                <option value="pilihcuti" {{ request('filter_izin') == 'pilihcuti' ? 'selected' : '' }}>
                                    Pilih Cuti</option>
                                <option value="sakit" {{ request('filter_izin') == 'sakit' ? 'selected' : '' }}>Sakit
                                </option>
                        ...
                        <textarea name="alasan" id="alasan_text" placeholder="Tolong jelaskan alasan cuti anda"
                            style="width: 100%; height: 150px; padding: 10px; border: 2px solid crimson; border-radius: 8px; box-sizing: border-box;"></textarea>
                        ...
                        <p style="margin: 0; padding: 0; font-size: 14px;">Silahkan unggah berkas dalam bentuk foto atau pdf
                        </p>
                        ...
                        <div class="upload-container" style="text-align: center; padding: 10px;">
                            <input name="file" type="file" id="upload_image" accept="image/*,application/pdf"
                                style="display: block; margin-bottom: 10px;">

                            <div class="image-preview" id="imagePreview"
                                style="border: 1px solid #ddd; width: 300px; height: 300px; display: flex; justify-content: center; align-items: center;">
                                <p>No file chosen</p>
                            </div>
                        </div>
            ...
            <div class="d-flex justify-content-center">
                <div class="modal fade" id="berhasilModal" tabindex="-1" aria-labelledby="absenModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content" style="max-width: 400px; width: 100%">
                            <div class="modal-body text-center p-4">
                                <!-- Gambar emoji absen -->
                                <img src="{{ asset('img/Emoji_berhasil.svg') }}" alt="Absen Berhasil" width="100"
                                    height="100">
                    ...
                    <tbody>
                        @foreach ($pengajuanCuti as $cuti)
                            <tr>
                                ...
                                <!-- Periode Cuti -->
                                <td>{{ \Carbon\Carbon::parse($cuti->start_date)->format('d/m/Y') }} s/d
                                    {{ \Carbon\Carbon::parse($cuti->end_date)->format('d/m/Y') }}</td>

                                <!-- Status Cuti dengan warna sesuai status -->
                                <td>
                                    <span
                                        style="background-color: 
                            @if ($cuti->status == 'ditolak') crimson 
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    // Jika semua validasi berhasil, nonaktifkan tombol
                    btnAjukan.disabled = true;
                    btnAjukan.innerText = 'Diproses...';
                });
            });
        </script>
    </body>
