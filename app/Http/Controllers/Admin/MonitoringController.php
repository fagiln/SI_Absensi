...
{
    public function index(MonitoringDataTable $dataTable, Request $request)
    {
        ...
        return $dataTable->render('admin.monitoring.monitoring', compact('kehadirans', 'filterDate', 'filterKehadiran'));
    }
